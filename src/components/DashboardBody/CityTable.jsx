            ...
            <tr className="main-header">
              <th colSpan={1}>
                <div className="sku-header-content">
                  <img src={SKUIcon} alt="City Icon" className="sku-header-icon" />
                  SKU Name
                </div>
              </th>
            ...
            {CityData.map((row, index) => (
              <tr key={index} className={`data-row ${row.isChecked ? 'checked' : ''}`}>
                <td className="sku-name-cell">
                  ...
                  />
                  <span className="sku-name">{row.cityName}</span>
                </td>
                <td>
                ...
                <td>
                  <div className="data-cell">
                    <div className="main-value">{row.outOfStock}</div>
                    {row.stockChange && (
                      <div className={`change ${row.stockChange.direction}`}>
                        <img 
                ...
                <td>
                  <div className="data-cell">
                    <div className="main-value">{row.totalInventory}</div>
                  </div>
                </td>
                <td>
                  <div className="data-cell">
                    <div className="main-value">{row.averageRank}</div>
                    {row.rankChange && (
                      <div className={`change ${row.rankChange.direction}`}>
                        <img 
                ...
                <td>
                  <div className="data-cell">
                    <div className="main-value">{row.estTraffic}</div>
                    {row.trafficChange && (
                      <div className={`change ${row.trafficChange.direction}`}>
                        <img 
                ...
                <td>
                  <div className="data-cell">
                    <div className="main-value">{row.estImpressions}</div>
                    {row.impressionsChange && (
                      <div className={`change ${row.impressionsChange.direction}`}>
                        <img 
                ...
                <td>
                  <div className="data-cell">
                    <div className="main-value">{row.cl}</div>
                  </div>
                </td>
              </tr>
            ))}
